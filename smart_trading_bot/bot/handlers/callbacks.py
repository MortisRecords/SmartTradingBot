...
def register_all_handlers(application: Application, db_manager):
    ...
    application.add_handler(CommandHandler("stats", referral_handler.stats_command))
    ...
    application.add_handler(CommandHandler("broadcast", admin_handler.broadcast_message))
    application.add_handler(CommandHandler("users", admin_handler.users_stats))
    application.add_handler(CommandHandler("signals_stats", admin_handler.signals_stats))
